...
appendix_path_candidates = [
   Path('/home/smayan/Desktop/QPM/docs/resources/figure_appendix.md'),
   Path('/home/smayan/Desktop/QPM/extracted/figure_appendix.md'),
]
for appendix_path in appendix_path_candidates:
   if appendix_path.exists():
      appendix = appendix_path.read_text(encoding='utf-8')
      break
else:
   raise FileNotFoundError('figure_appendix.md not found in docs/resources or extracted/')
