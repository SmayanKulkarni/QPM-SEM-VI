...
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 3}\enspace\textit{three-asset fund case}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Equity/Bond/Commodity with given covariances and weights in source.
  \item Source computes MCR, TRC, PRC and shows equity highest risk share.
\end{itemize}

\noindent\textbf{Interpretation:} rebalance needed if target is balanced risk profile.

\noindent\rule{\linewidth}{0.4pt}
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 4}\enspace\textit{risk-control decision}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Use PRC table to identify breach against target risk budget.
  \item Action: reduce high PRC asset weight and increase under-allocated defensive assets.
\end{itemize}
...
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 2}\enspace\textit{capital-to-risk decomposition}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Portfolio value INR 1,00,000 with A/B/C allocations.
  \item Compute weights, then risk contributions and shares exactly as in source.
  \item Source output shows stock A largest risk budget usage.
\end{itemize}
...
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 4}\enspace\textit{target vs actual risk case}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Compare actual risk contribution against target budget.
  \item Source recommendation: reduce equity exposure, increase bond/commodity weight.
\end{itemize}
...
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 1}\enspace\textit{3-asset base case}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Given sigmas from source, compute inverse volatilities.
  \item Normalize to get weights.
  \item Source shows low-volatility asset receives highest weight.
\end{itemize}

\noindent\rule{\linewidth}{0.4pt}
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 2}\enspace\textit{4-asset case study}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Equity 24\%, Bond 8\%, Commodity 16\%, Real Estate 12\%
  \item Inverse-vol scores and normalized weights shown in OCR source.
  \item Bond gets largest weight due to lowest sigma.
\end{itemize}
...
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 4}\enspace\textit{allocation in rupees}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Total capital INR 10,00,000 across 4 assets.
  \item Use risk-parity weights from source OCR to compute rupee allocations.
\end{itemize}

\noindent\rule{\linewidth}{0.4pt}
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 5}\enspace\textit{equal-weight vs risk-parity comparison}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Risk parity lowers weight of highest-volatility stock and raises low-volatility stock weight.
  \item Source
\end{itemize}

\noindent\textbf{Interpretation:} better risk diversification than equal weight.
...
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 1}\enspace\textit{3-asset variance decomposition}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Use variance terms plus covariance cross-terms exactly as shown.
  \item Sum all terms $\Rightarrow$ portfolio variance; $\sigma_p = \sqrt{\sigma_p^2}$.
  \item Source
\end{itemize}

\noindent\textbf{Interpretation:} diversification reduces total risk below individual sigmas.

\noindent\rule{\linewidth}{0.4pt}
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 2}\enspace\textit{equity-bond-commodity case}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Given weights, sigmas, and correlations.
  \item Compute each variance and cross-covariance term; sum $\Rightarrow \sigma_p$.
  \item Source
\end{itemize}

\noindent\textbf{Interpretation:} equities dominate risk share due to high sigma and weight.
...
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 5}\enspace\textit{portfolio risk case}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Update variance A, variance B, covariance AB using EWMA.
  \item Then compute portfolio variance with weights 0.6 and 0.4.
  \item Source OCR gives final portfolio variance near 0.03185.
\end{itemize}
...
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 5}\enspace\textit{multi-period CPPI case}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Source tracks period-by-period allocations and confirms no floor violation in first case.
\end{itemize}

\noindent\rule{\linewidth}{0.4pt}
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 6}\enspace\textit{stress case with gap risk}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Aggressive multiplier and crash lead to floor breach and loss lock-in in safe assets.
\end{itemize}

\noindent\rule{\linewidth}{0.4pt}
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 7}\enspace\textit{GBM-linked CPPI OCR case}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Downward random shock reduces risky sleeve and preserves floor margin.
\end{itemize}
...
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 1}\enspace\textit{Jensen ranking of 3 portfolios}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Source PDF computes expected returns using CAPM inputs and then differences from actual return.
  \item Ranked based on alpha differential.
\end{itemize}

\noindent\rule{\linewidth}{0.4pt}
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 2}\enspace\textit{Sharpe ranking across funds}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Source computes multiple Sharpe values and rank ordering.
\end{itemize}

\noindent\rule{\linewidth}{0.4pt}
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 3}\enspace\textit{Treynor ranking across funds}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Source computes Treynor values and ranks.
\end{itemize}

\noindent\rule{\linewidth}{0.4pt}
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 4}\enspace\textit{Jensen for A/B/C/D funds}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Source page computes alpha values, including negative alpha cases.
\end{itemize}

\noindent\rule{\linewidth}{0.4pt}
\medskip
\noindent\rule{\linewidth}{0.4pt}
\noindent\textbf{Example 5}\enspace\textit{additional OCR illustrations}

\noindent\textbf{Steps:}
\begin{itemize}\setlength{\itemsep}{3pt}
  \item Multiple worked mutual fund comparisons in the numericals PDF.
\end{itemize}
